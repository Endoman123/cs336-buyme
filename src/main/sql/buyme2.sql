...
INSERT INTO `auction_transactions` VALUES (1,1,'Mikita_Belausau','2021-04-15','23:00:00','Dorian_Hobot',2,2,18,NULL),(2,1,'Mikita_Belausau','2021-04-15','23:00:00','Person',2,2,25,NULL);
...
CREATE TABLE `autobid` (
  ...
  PRIMARY KEY (`login`,`auction_ID`),
  KEY `auction_ID` (`auction_ID`),
  CONSTRAINT `autobid_ibfk_1` FOREIGN KEY (`auction_ID`) REFERENCES `auction_transactions` (`auction_ID`),
  CONSTRAINT `autobid_ibfk_2` FOREIGN KEY (`login`) REFERENCES `user` (`login`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `end_user` VALUES ('Customer',NULL),('customer1',NULL),('hello',NULL),('person',NULL),('person2',NULL),('person3',NULL);
...
-- Dump completed on 2021-04-19 16:51:06
